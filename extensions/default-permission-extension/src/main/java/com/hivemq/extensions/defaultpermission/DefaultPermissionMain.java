...
public class DefaultPermissionMain implements ExtensionMain {
    private static final @NotNull Logger log = LoggerFactory.getLogger(DefaultPermissionMain.class);
    ...
    public void extensionStart(
        ...
        try {
            Services.interceptorRegistry().setConnectInboundInterceptorProvider(input -> {
                ...
                return new DefaultPermissionConnectInterceptor();
            });
