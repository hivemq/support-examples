...
public class DefaultPermissionConnectInterceptor  implements ConnectInboundInterceptor {
    private static final @NotNull Logger log = LoggerFactory.getLogger(DefaultPermissionConnectInterceptor.class);
